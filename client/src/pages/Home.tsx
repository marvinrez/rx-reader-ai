    ...
    setTimeout(() => {
      setMessages(prev => [
        ...prev,
        {
          ...
          prescriptionId: null,
          type: 'ai',
          content: "**Important Disclaimer:**\n\nThe information provided is generated by artificial intelligence and should be used for reference only. AI systems can make mistakes in interpretation. Always verify prescriptions with your healthcare provider and pharmacist. Remember to follow your doctor's instructions before taking any medication.\n\nIf you have any questions or need further clarification, I'm here to help, but please consult with qualified healthcare professionals for medical decisions.",
          metadata: null,
          createdAt: new Date()
        }
      ]);
