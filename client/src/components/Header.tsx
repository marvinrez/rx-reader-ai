        ...
        <Dialog>
          <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                <DropdownMenuItem onSelect={() => document.getElementById('faq-dialog-trigger')?.click()}>
                  FAQ
                </DropdownMenuItem>
                <DropdownMenuItem onSelect={() => document.getElementById('about-dialog-trigger')?.click()}>
                  About
                </DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
          ...
          <Dialog>
            <DialogTrigger asChild>
              <button id="faq-dialog-trigger" className="hidden">FAQ</button>
            </DialogTrigger>
            <DialogContent>
              <DialogHeader>
          ...
          <Dialog>
            <DialogTrigger asChild>
              <button id="about-dialog-trigger" className="hidden">About</button>
            </DialogTrigger>
            <DialogContent>
              <DialogHeader>
